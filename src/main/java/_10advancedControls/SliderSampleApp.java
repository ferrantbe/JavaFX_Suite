...
public class SliderSampleApp extends Application {
    // Source: https://docs.oracle.com/javafx/2/ui_controls/slider.htm

    final Slider opacityLevel = new Slider(0, 1, 1);
    final Slider sepiaTone = new Slider(0, 1, 1);
    final Slider scaling = new Slider (0.1, 1, 1);
